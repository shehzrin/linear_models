...
Most diagnostics use residuals. Now have normal dataframe and the nyc_airbnb can be any data (model can be used on any data)
...
Could just fit sepearate models. 
...
```{r}
manhattan_neighborhood_ft_df = 
nyc_airbnb |>
  filter(borough == "Mannhattan") |>
